...
if %opcion%==4 goto abrirFC26webapp
...
:abrirFC26WEBAPP
echo Entrando en FC26 web app...
start https://www.ea.com/ea-sports-fc/ultimate-team/web-app/
echo Regresando al menu principal...
goto inicio
...
start https://www.youtube.com/watch?v=uXCtOk5dedI
echo Regresando al menu principal...
goto inicio

:videoFav2
echo Ingresando a youtube para reproducir Video Favorito 2...
start https://www.youtube.com/watch?v=FylpygEYYbE
echo Regresando al menu principal...
goto inicio
